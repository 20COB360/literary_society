...
<body>
    <div class="containerx">
        <h1 class="explore">EXPLORE ARTICLES</h1>
    ...
    <div class="container">
        <?php
        $sql = "Select * from articles ORDER BY timestamp DESC limit 20 ";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {

            echo ' <a href="./individual_articles.php?article_id=' . $row['article_id'] . '" >
            <div class="content">
