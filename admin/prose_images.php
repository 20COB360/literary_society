  ...
  function addImage($image_name,$file_name,$file_tmp_name,$file_error,$file_size,$key){
    ...
    if($file_error===0){
      if ($file_size>2000000) {
       ...
       header("Location: prose_images.php?error=$em");
      }
     else{
        ...
        $file_ex_lc=strtolower($file_ex);
            ...
            if (in_array($file_ex_lc,$allowed_exs)) {
             ...
             if($image_name!= "default.jpg"){
              ...
              // die("Succeses");
              header("Location: prose_images.php?key=$key&success=true");
            }
            else{
...
<body>
   ...
   ?>
    ...
    <div class="container my-5">
        ...
        <div class="row ">
            <?php
              $sql="Select * from proses where prose_id='$key' ";
            ...
            //  var_dump ($result);
                ...
                <div class="card" >
                    ...
                    <center><form action="prose_images.php" method="post" enctype="multipart/form-data">
